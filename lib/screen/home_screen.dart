...
import "package:flutter_phonepe_demo/crud_operations/crud_operations.dart";
import "package:flutter_phonepe_demo/singletons/phonepe_singleton.dart";
import "package:flutter_phonepe_demo/widgets/grid_view_widget.dart";
import "package:flutter_phonepe_demo/widgets/list_view_widget.dart";
  ...
  Widget floatingActionButton() {
    return CRUDOperationsController().cartListFunction().isNotEmpty &&
        ...
        ? FloatingActionButton.extended(
            onPressed: () async {
              await PhonePeSingleton().makePayment(
